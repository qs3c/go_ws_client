...
/*
#cgo CFLAGS: -ID:/go_ws_client/third_party/tongsuo-install/include -DOPENSSL_API_COMPAT=0x10100000L
#cgo LDFLAGS: -LD:/go_ws_client/third_party/tongsuo-install -LD:/go_ws_client/third_party/tongsuo-install/lib -lcrypto -lssl
#include "shim.h"
*/
import "C"
